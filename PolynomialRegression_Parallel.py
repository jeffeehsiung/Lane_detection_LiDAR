...
class PolynomialRegression_Parallel:
    X_left_length = None
    X_right_length = None
    ...
    @classmethod
    def set_static_variables(cls, X_left_length, X_right_length):
        cls.X_left_length = X_left_length
        cls.X_right_length = X_right_length
        
    def fit(self, X, y):
        X_left = X[:PolynomialRegression_Parallel.X_left_length]
        X_right = X[PolynomialRegression_Parallel.X_left_length:]
        y_left = y[:PolynomialRegression_Parallel.X_left_length]
        y_right = y[PolynomialRegression_Parallel.X_left_length:]
        
        poly_regression = PolynomialRegression(degree=self.degree) 
        
        # print(f"X_left: {X_left.shape}, y_left: {y_left.shape}, X_right: {X_right.shape}, y_right: {y_right.shape}")
    ...
    def score(self, X, y):
        ...
        y_left = y[:PolynomialRegression_Parallel.X_left_length]
        y_right = y[PolynomialRegression_Parallel.X_left_length:]
        x_range = np.linspace(X_left.min(), X_left.max(), 1000)
